...
const FilterSection = ({ title, children }) => (
    <div className="flex flex-col gap-4">
        <p className="text-[#90A3BF] text-xs font-semibold uppercase tracking-widest">{title}</p>
...
const FilterSidebar = () => {
    ...
    const hasActiveFilters = filters.category || filters.capacity || filters.maxPrice;
