        ...
        <nav className="bg-white border-b border-[#C3D4E9] border-opacity-40 sticky top-0 z-50">
            <div className="max-w-[1440px] mx-auto px-6 py-6 pb-8 md:py-6">
                ...
                <div className="flex flex-col gap-8 md:hidden">
                    <div className="flex items-center justify-between">
                        ...
                        {isAuthenticated ? (
                            <div className="relative" ref={mobileDropdownRef}>
                                ...
                                {isProfileOpen && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-[10px] shadow-lg py-1 border border-[#C3D4E9] border-opacity-40 z-50">
                                        ...
                                        <button onClick={handleLogout} className="block w-full text-left px-4 py-2 text-sm font-semibold text-red-600 hover:bg-gray-50 transition-colors">
                                            Log Out
                                        </button>
                                    </div>
                                )}
                            ...
                            <Link to="/login" className="text-[#3563E9] text-sm font-semibold">Login</Link>
                        )}
                    </div>
                ...
                <div className="hidden md:flex items-center justify-between gap-4">
                    ...
                    <form
                        onSubmit={handleSearch}
                        className="flex-grow max-w-[492px] flex items-center h-[44px] px-4 rounded-full border border-[#C3D4E9] border-opacity-40 focus-within:ring-2 focus-within:ring-[#3563E9] ml-8"
                    >
                        ...
                        />
                        <button type="submit">
                            <FilterIcon className="w-5 h-5 text-[#596780] cursor-pointer hover:text-[#3563E9]" />
                        </button>
                    </form>
                            ...
                            <div className="relative" ref={desktopDropdownRef}>
                                ...
                                {isProfileOpen && (
                                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-[10px] shadow-lg py-1 border border-[#C3D4E9] border-opacity-40 z-50">
                                        ...
                                        <button onClick={handleLogout} className="block w-full text-left px-5 py-3 text-sm font-semibold text-red-600 hover:bg-gray-50 transition-colors">
                                            Log Out
                                        </button>
                                    </div>
                                )}
